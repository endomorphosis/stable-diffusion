...
# add public ip to ip interfaces
IP_INTERFACES=$(echo  $IP_INTERFACES $PUBLIC_IP)
#echo $IP_INTERFACES
IP_INTERFACES_JSON="{"
...
SERVER_REPORT_JSON="{\"gpus\": $SERVER_DATA_JSON, \"ip_interfaces\": $IP_INTERFACES_JSON}"
echo $SERVER_REPORT_JSON > server.json
